...
@interface GMapkitViewController () {
    NSArray *_arrMenus;
}

@end

@implementation GMapkitViewController
...
- (void)initDatas {
    _arrMenus = [NSArray arrayWithObjects:@"GMapkit显示", nil];
}
